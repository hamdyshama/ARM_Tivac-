...
{
   if(Copy_Direction == DIR_OUTPUT )
  { 
    switch(Copy_u8Port)
    {
    case GPIOA_PORT :  SET_BIT(GPIO_PORTA_DIR_R,copy_u8Pin);               break ;
    case GPIOB_PORT :  SET_BIT(GPIO_PORTB_DIR_R,copy_u8Pin);               break ;
    case GPIOC_PORT :  SET_BIT(GPIO_PORTC_DIR_R,copy_u8Pin);               break ;
    case GPIOD_PORT :  SET_BIT(GPIO_PORTD_DIR_R,copy_u8Pin);               break ;
    case GPIOE_PORT :  SET_BIT(GPIO_PORTE_DIR_R,copy_u8Pin);               break ;
    case GPIOF_PORT :  SET_BIT(GPIO_PORTF_DIR_R,copy_u8Pin);               break ;
    default :                                                                      break ;
    }                   
  }                     
  else                  
  {                     
    switch(Copy_u8Port)
    {                   
    case GPIOA_PORT :  CLR_BIT(GPIO_PORTA_DIR_R,copy_u8Pin);               break ;
    case GPIOB_PORT :  CLR_BIT(GPIO_PORTB_DIR_R,copy_u8Pin);               break ;
    case GPIOC_PORT :  CLR_BIT(GPIO_PORTC_DIR_R,copy_u8Pin);               break ;
    case GPIOD_PORT :  CLR_BIT(GPIO_PORTD_DIR_R,copy_u8Pin);               break ;
    case GPIOE_PORT :  CLR_BIT(GPIO_PORTE_DIR_R,copy_u8Pin);               break ;
    case GPIOF_PORT :  CLR_BIT(GPIO_PORTF_DIR_R,copy_u8Pin);               break ;
    default :                                                                      break ;
    }
  }
...
void MGPIO_voidSetPinValue(u8 Copy_u8Port ,u8 Copy_u8Pin , u8 Copy_u8Value )
{
  if(Copy_u8Value == HIGH )
  {
     switch (Copy_u8Port)
    {
          case GPIOA_PORT :  SET_BIT(GPIO_PORTA_DATA_R,Copy_u8Pin);       break ;
          case GPIOB_PORT :  SET_BIT(GPIO_PORTB_DATA_R,Copy_u8Pin);       break ;
          case GPIOC_PORT :  SET_BIT(GPIO_PORTC_DATA_R,Copy_u8Pin);       break ;
          case GPIOD_PORT :  SET_BIT(GPIO_PORTD_DATA_R,Copy_u8Pin);       break ;
          case GPIOE_PORT :  SET_BIT(GPIO_PORTE_DATA_R,Copy_u8Pin);       break ;
          case GPIOF_PORT :  SET_BIT(GPIO_PORTF_DATA_R,Copy_u8Pin);       break ;
          default :                                                      break ;
    }           
  }             
  else          
  {             
       switch (Copy_u8Port)
    {           
          case GPIOA_PORT :  CLR_BIT(GPIO_PORTA_DATA_R,Copy_u8Pin);         break ;
          case GPIOB_PORT :  CLR_BIT(GPIO_PORTB_DATA_R,Copy_u8Pin);         break ;
          case GPIOC_PORT :  CLR_BIT(GPIO_PORTC_DATA_R,Copy_u8Pin);         break ;
          case GPIOD_PORT :  CLR_BIT(GPIO_PORTD_DATA_R,Copy_u8Pin);         break ;
          case GPIOE_PORT :  CLR_BIT(GPIO_PORTE_DATA_R,Copy_u8Pin);         break ;
          case GPIOF_PORT :  CLR_BIT(GPIO_PORTF_DATA_R,Copy_u8Pin);         break ;
          default :                                                          break ;
    }
...
void MGPIO_voidPortPullUp(u8 Copy_u8Port ,u8 copy_u8PVal)
{
   switch(Copy_u8Port)
    {
